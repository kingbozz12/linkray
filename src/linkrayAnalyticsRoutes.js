...
<link rel="icon" href="/brand/linkray-logo.svg">
<link rel="apple-touch-icon" href="/brand/linkray-logo.svg">
<meta property="og:title" content="LinkRay Analytics">
<meta property="og:image" content="/brand/linkray-logo.svg">
...
<nav class="mobile-dock"><a href="#chart">График</a><a href="#placements">Каналы</a><button class="primary" data-action="share">Поделиться</button></nav>
</main>
...
export function mountLinkRayAnalyticsRoutes(app) {
  ...
  const sendLogo = (_req, res) => {
    ...
    if (LOGO_PNG && false) return res.sendFile(LOGO_PNG);
    return res.sendFile(LOGO_SVG);
  };
  ...
  app.get('/api/linkray/brand', (req, res) => {
    ...
    const logo = `${proto}://${host}/brand/linkray-logo.svg`;
