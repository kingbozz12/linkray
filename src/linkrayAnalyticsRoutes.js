...
<link rel="icon" type="image/webp" href="/brand/linkray-logo.webp?v=preview2">
<link rel="apple-touch-icon" href="/brand/linkray-logo.webp?v=preview2">
<meta property="og:title" content="LinkRay Analytics">
<meta property="og:image" content="/brand/linkray-logo.webp?v=preview2">
...
.brand-logo{
  background-image:url("/brand/linkray-logo.webp?v=preview2")!important;
...
export function mountLinkRayAnalyticsRoutes(app) {
  ...
  const sendLogo = (_req, res) => {
    ...
    res.type('webp');
    return res.sendFile(path.join(BRAND_DIR, 'linkray-logo.webp'));
  };
  ...
  app.get('/api/linkray/brand', (req, res) => {
    ...
    const logo = `${proto}://${host}/brand/linkray-logo.webp?v=preview2`;
